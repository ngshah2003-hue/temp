...
const adminSchema = new mongoose.Schema(
    {
        ...
        [TableFields.passwordResetExpires]: {
            type: Date,
        },
    },
    {
...
adminSchema.methods.createPasswordResetToken = function () {
    ...
    this[TableFields.passwordResetToken] = crypto
        ...
        .update(resetToken)
        .digest("hex");
    this[TableFields.passwordResetExpires] = Date.now() + 3600000; // Token expires in 1 hr [can be modified later according to requirement]
    return resetToken;
};
